...
You can start using Rocketlane directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Rocketlane.
...
The full list of available tools is at [./src/universal_mcp_rocketlane/README.md](./src/universal_mcp_rocketlane/README.md)
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_rocketlane/server.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_rocketlane/server.py
   ```
